...
lyr_PARCELLES_6.set('fieldLabels', {'id': 'inline label - always visible', 'TYPE': 'header label - always visible', 'DISTRICT': 'header label - always visible', 'GERANT': 'hidden field', 'SOUS_PREF': 'header label - always visible', 'GROUPEMENT': 'header label - always visible', });
lyr_PARCELLEvrifier_7.set('fieldLabels', {'id': 'no label', 'TYPE': 'header label - always visible', 'DISTRICT': 'header label - always visible', 'GERANT': 'header label - always visible', 'SOUS_PREF': 'header label - always visible', 'GROUPEMENT': 'header label - always visible', });
